...
%Q: pokud všude použijeme omezené kvantifikátory s $y =$ velikost částic ve vesmíru, dostaneme upravenou logiku pro počítače?
...
\begin{theorem}[Omezená kvantifikace (BD)]\label{omez_kvant}
...
\begin{theorem}[Neomezená kvantifikace]\label{neomez_kvant}
...
\begin{theorem}[Postova věta podruhe]
