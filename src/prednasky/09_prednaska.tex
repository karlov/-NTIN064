...
\begin{definition}[Predikát $\in \Sigma_n$]
...
\begin{theorem}[Neexistence $\Sigma_0^0$ univerzálního ORP]
...
\begin{consequence}[Predikat mimo $\Sigma_n^0, \Pi_n^0$]
